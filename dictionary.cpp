...
void printsug(struct trieNode* root, char allWords[], int index, string prefix)
{
    struct trieNode* pCrawl = root;
    ...
    for(int i = 0; i < ALPHABET_SIZE; i++)  {
        if(pCrawl->children[i] != NULL) {
            allWords[index] = 'a' + i;
            printsug(pCrawl->children[i], allWords, index + 1, prefix);
        }
    }
}
void printsugest(struct trieNode* root, string prefix)
{
    struct trieNode* pCrawl = root;
    ...
    char allWords[50];
    printsug(pCrawl, allWords, 0, prefix);
}
...
bool suggestedWords(struct trieNode* root, string word)
{
    int count = 0;
...
void menu(){
    ...
    printf("\t\t\t\t|                                                         |\n");
    printf("\t\t\t\t|=========================================================|\n");
            cout << "\t\t\t    Welcome to our Dictionary. Our Dictionary right now contains " << countword << " words.\n";
...
int main()  {
    ...
    printf("\t\t\t\t                       | Made By  |\n\n");
    printf("\t\t\t |-------------|    |---------------|    |-------------|    |-------------|\n");
    printf("\t\t\t |   PIYUSH    |    |     LALIT     |    |     AVI     |    |   PUSHPAK   |\n");
    printf("\t\t\t |-------------|    |---------------|    |-------------|    |-------------|\n");
